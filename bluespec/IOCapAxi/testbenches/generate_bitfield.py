...
class CppGenerator:
    ...
    def generate_or_expression(self, output_name: str, output_backing: BackingPrimitive, or_components: List[OrComponent]) -> str:
        ...
        for or_component in or_components:
            ...
            if (or_component.extract_type.width != output_backing.width) and (or_component.extract_width == min(or_component.extract_type.width, output_backing.width)):
                comp = comp
            else:
    ...
    def generate(self, struct: Struct):
        ...
        for field in struct.fields:
            ...
            while bits_needed > 0:
                ...
                if (backing_elem_prim.width - idx_backing_elem_bit) > bits_needed:
                    ...
                    # (backing.width - idx_backing_elem_bit) <= bits_needed
                    # We need all of this field.
                    or_components.append(OrComponent(
                        backing_elem_name, backing_elem_prim,
                        extract_first_bit=idx_backing_elem_bit,
...
STRUCTS = BLUESPEC_IOCAPAXI_STRUCTS
